...
the ``app_config`` settings singleton. Server defaults mirror the out-of-the-box constants in
``app.models.app_config`` so a freshly-inserted row keeps the built-in behaviour.
