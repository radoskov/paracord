...
def estimate_vram_gb(
    params_b: float, quant: str = "Q4_K_M", *, context_tokens: int = 4096
) -> float:
...
_CATALOG: list[dict] = [
    # --- general-purpose LLMs (summaries / recommend) --------------------------------------------
    {
        ...
        "kind": "llm",
        "popularity": 96,
        "blurb": "Llama 3.2 3B — fast, capable small general model.",
    },  # noqa: E501
    {
        "name": "llama3.2:1b",
        "family": "llama3.2",
        ...
        "kind": "llm",
        "popularity": 88,
        "blurb": "Llama 3.2 1B — tiny, runs on almost anything.",
    },  # noqa: E501
    {
        "name": "llama3.1:8b",
        "family": "llama3.1",
        ...
        "kind": "llm",
        "popularity": 97,
        "blurb": "Llama 3.1 8B — strong all-round mid-size model.",
    },  # noqa: E501
    {
        "name": "qwen3:0.6b",
        "family": "qwen3",
        ...
        "kind": "llm",
        "popularity": 80,
        "blurb": "Qwen3 0.6B — smallest Qwen3, ultra-light.",
    },  # noqa: E501
    {
        "name": "qwen3:1.7b",
        "family": "qwen3",
        ...
        "kind": "llm",
        "popularity": 86,
        "blurb": "Qwen3 1.7B — light general model.",
    },  # noqa: E501
    {
        "name": "qwen3:4b",
        "family": "qwen3",
        "params_b": 4.0,
        "quant": "Q4_K_M",
        "size_bytes": 2_497_280_480,
        "kind": "llm",
        "popularity": 93,
        "blurb": "Qwen3 4B — strong small general model.",
    },  # noqa: E501
    {
        "name": "qwen3:8b",
        "family": "qwen3",
        ...
        "kind": "llm",
        "popularity": 90,
        "blurb": "Qwen3 8B — capable mid-size model.",
    },  # noqa: E501
    {
        "name": "qwen3:14b",
        "family": "qwen3",
        ...
        "kind": "llm",
        "popularity": 84,
        "blurb": "Qwen3 14B — larger, needs a real GPU.",
    },  # noqa: E501
    {
        "name": "qwen2.5:3b",
        "family": "qwen2.5",
        ...
        "kind": "llm",
        "popularity": 82,
        "blurb": "Qwen2.5 3B — solid small general model.",
    },  # noqa: E501
    {
        "name": "qwen2.5:7b",
        "family": "qwen2.5",
        ...
        "kind": "llm",
        "popularity": 88,
        "blurb": "Qwen2.5 7B — well-rounded mid-size model.",
    },  # noqa: E501
    {
        "name": "gemma3:1b",
        "family": "gemma3",
        ...
        "kind": "llm",
        "popularity": 84,
        "blurb": "Gemma 3 1B — tiny Google model.",
    },  # noqa: E501
    {
        "name": "gemma3:4b",
        "family": "gemma3",
        ...
        "kind": "llm",
        "popularity": 91,
        "blurb": "Gemma 3 4B — capable small model.",
    },  # noqa: E501
    {
        "name": "gemma3:12b",
        "family": "gemma3",
        ...
        "kind": "llm",
        "popularity": 82,
        "blurb": "Gemma 3 12B — larger, needs a GPU.",
    },  # noqa: E501
    {
        "name": "phi4",
        "family": "phi4",
        ...
        "kind": "llm",
        "popularity": 83,
        "blurb": "Phi-4 14B — strong reasoning for its size.",
    },  # noqa: E501
    {
        "name": "phi3.5",
        "family": "phi3.5",
        ...
        "kind": "llm",
        "popularity": 79,
        "blurb": "Phi-3.5 3.8B — compact, capable.",
    },  # noqa: E501
    {
        "name": "mistral",
        "family": "mistral",
        ...
        "kind": "llm",
        "popularity": 89,
        "blurb": "Mistral 7B — classic fast mid-size model.",
    },  # noqa: E501
    {
        "name": "deepseek-r1:7b",
        "family": "deepseek-r1",
        ...
        "kind": "llm",
        "popularity": 85,
        "blurb": "DeepSeek-R1 7B — reasoning-focused model.",
    },  # noqa: E501
    {
        "name": "deepseek-r1:8b",
        "family": "deepseek-r1",
        ...
        "kind": "llm",
        "popularity": 83,
        "blurb": "DeepSeek-R1 8B — reasoning-focused model.",
    },  # noqa: E501
    # --- embedding models (semantic search / related papers) -------------------------------------
    {
        ...
        "kind": "embedding",
        "popularity": 98,
        "blurb": "Nomic embeddings (768-dim) — the recommended default for semantic search.",
    },  # noqa: E501
    {
        ...
        "kind": "embedding",
        "popularity": 90,
        "blurb": "mxbai large embeddings (1024-dim) — higher quality, larger.",
    },  # noqa: E501
    {
        "name": "bge-m3",
        "family": "bge-m3",
        ...
        "kind": "embedding",
        "popularity": 85,
        "blurb": "BGE-M3 embeddings (1024-dim) — multilingual.",
    },  # noqa: E501
    {
        "name": "all-minilm",
        "family": "all-minilm",
        ...
        "kind": "embedding",
        "popularity": 78,
        "blurb": "all-MiniLM (384-dim) — tiny, fast embeddings.",
    },  # noqa: E501
    {
        ...
        "kind": "embedding",
        "popularity": 76,
        "blurb": "Snowflake Arctic embeddings — strong retrieval quality.",
    },  # noqa: E501
]
